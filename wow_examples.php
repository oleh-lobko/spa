...
<?php if (have_rows('services_with_excerpt')) { ?>
    <?php while (have_rows('services_with_excerpt')) {
        the_row();
...
<?php the_post_thumbnail('full', ['class' => 'img-responsive']); ?> /*<-- Enter Classes here-->*/
...
$args = [
    ...
    'tag__not_in' => [2, 6],
    // (array) - use tag ids.
    'tag_slug__and' => ['red', 'blue'],
    // (array) - use tag slugs.
    'tag_slug__in' => ['red', 'blue'],
    // (array) - use tag slugs.
...
<?php if ($location = get_field('location')) { ?>
    <div class="acf-map">
        <div class="marker" data-lat="<?php echo $location['lat']; ?>" data-lng="<?php echo $location['lng']; ?>"
             data-marker-icon="<?php echo asset_path('images/map_marker.png'); ?>"><?php echo '<p>' . $location['address'] . '</p>'; ?></div>
    </div>
<?php } ?>
...
<?php if ($location = get_field('location')) { ?>
    <div class="acf-map">
        <div class="marker" data-lat="<?php echo $location['lat']; ?>"
             data-lng="<?php echo $location['lng']; ?>"><?php echo '<p>' . $location['address'] . '</p>'; ?></div>
    </div>
<?php } ?>
...
<div class="accordion" data-accordion data-allow-all-closed="true">
    <div class="accordion-item is-active" data-accordion-item>
        ...
        <div class="accordion-content" data-tab-content>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores magnam molestias, quas quasi sunt
                vero!</p>
        </div>
    </div>
    <div class="accordion-item" data-accordion-item>
        ...
        <div class="accordion-content" data-tab-content>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum earum, inventore laboriosam laudantium
                omnis vitae!</p>
        </div>
    </div>
    <div class="accordion-item" data-accordion-item>
        ...
        <div class="accordion-content" data-tab-content>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad facere fugiat iusto sequi sunt ut?</p>
        </div>
    </div>
</div>
...
<div class="tabs-content" data-tabs-content="example-tabs">
    <div class="tabs-panel is-active" id="panel1">
        <p>Vivamus hendrerit arcu sed erat molestie vehicula. Sed auctor neque eu tellus rhoncus ut eleifend nibh
            porttitor. Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis
            nisl tempor. Suspendisse dictum feugiat nisl ut dapibus.</p>
    </div>
    <div class="tabs-panel" id="panel2">
        <p>Suspendisse dictum feugiat nisl ut dapibus. Vivamus hendrerit arcu sed erat molestie vehicula. Ut in nulla
            enim. Phasellus molestie magna non est bibendum non venenatis nisl tempor. Sed
...
<!-- AJAX Placeholder -->
<?php
wp_localize_script('global', 'ajax', ['url' => admin_url('admin-ajax.php'), 'nonce' => wp_create_nonce('project_nonce')]);
